      ...
      <div class="col-6 col-lg">
        ...
        <ul class="list-unstyled">
          <li class="mb-3 d-flex">
            <svg class="icon" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
        ...
        <ul class="nav">
          <li class="nav-item">
            <a href="#" class="nav-link">
              <svg class="icon icon bg-primary-3" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          ...
          <li class="nav-item">
            <a href="#" class="nav-link">
              <svg class="icon icon bg-primary-3" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
