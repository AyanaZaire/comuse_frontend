  ...
  render() {
    return (
      ...
      {/*<div className='search_form'><h3>Find a class near you...</h3>
        ...
        <section
        className="bg-primary-3 has-divider text-light o-hidden"
        >
...
`               <div className="row justify-content-center text-center mb-5">
                  <div className="col-xl-8 col-lg-9">
                    <h2 className="display-4 mx-xl-6">Find what you're looking for.</h2>
                    <p className="lead">
                    ...
                    <Form style={{padding: "10px"}}>
                      ...
                      <Form.Group>
                        ...
                        block
                        >Search</Button>
                        {/*<button className="btn btn-lg btn-primary btn-block mb-2" type="submit">Search</button>*/}
                        {/*<input
                        name="course-name"
                        id="course-name-1"
                        type="text"
                    ...
                    {/*<small>Scroll down to see results.</small>*/}
                  </div>
                </div>

              {/*<div className="col-xl-5 col-lg-6 col-md-7 text-center text-lg-left mb-5 mb-lg-0">
                <h1 className="display-3">Find what you're looking for.</h1>
                <div className="my-4">
                  <p className="lead">Search classes by keyword.</p>
                </div>*/}
                {/*<div className="d-flex justify-content-center justify-content-lg-start">
                  <div className="d-flex mr-2">
                    <svg className="icon bg-warning" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div className="col-xl-8 col-md-10">
                    <Form>
                      ...
                      {/*<div className="form-group">
                        ...
                        <input name="course-email" id="course-email-1" type="email" className="form-control form-control-lg" placeholder="you@yoursite.com" />
                      </div>
                      <div className="row">
                        ...
                        <div className="col">
                          <div className="form-group rounded bg-white p-2 border">
                            <div className="custom-control custom-radio">
                              <input type="radio" id="course-radio-beginner-1" name="course-radio-1" className="custom-control-input" />
                              <label className="custom-control-label" for="course-radio-beginner-1">Beginner</label>
                            </div>
                          </div>
                        </div>
                        <div className="col">
                          <div className="form-group rounded bg-white p-2 border">
                            <div className="custom-control custom-radio">
                              <input type="radio" id="course-radio-advanced-1" name="course-radio-1" className="custom-control-input" />
                              <label className="custom-control-label" for="course-radio-advanced-1">Advanced</label>
                            </div>
                          </div>
                        </div>
                      </div>*/}
                      {/*<div className="form-group text-center">
                        <button className="btn btn-lg btn-primary btn-block mb-2" type="submit">Learn</button>
          ...
          <div className="decoration-wrapper d-none d-sm-block">
            <div data-jarallax-element="0 50">
              <div className="decoration top middle-y scale-5">
                <svg className="bg-primary-2" width="183" height="166" viewBox="0 0 183 166" fill="none" xmlns="http://www.w3.org/2000/svg">
